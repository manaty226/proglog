...
import (
	...
	healthbb "google.golang.org/grpc/health/grpc_health_v1"
...
func NewGRPCServer(config *Config, grpcOpts ...grpc.ServerOption) (*grpc.Server, error) {
	...
	hsrv.SetServingStatus("", healthbb.HealthCheckResponse_SERVING)
	healthbb.RegisterHealthServer(gsrv, hsrv)
